...
const FEATURES: Feature[] = [
  {
    icon: '🌀',
    name: 'Chaos Mode',
    hook: 'Tap Randomize to see what could happen in any group',
  ...
  },
  {
    ...
    hook: 'Pick a team. See every path to the next round.',
    href: '/groups?section=qualification',
    highlight: true,
  },
  {
    icon: '🏆',
    name: 'Pick the Winners',
    hook: 'Predict all 31 knockout matches. Share your picks.',
    href: '/bracket',
  },
  {
    icon: '⚔️',
    name: 'If This Happens',
    hook: 'Set match results yourself. Watch the table react.',
    href: '/groups?section=simulator',
  },
  {
    icon: '📊',
    name: 'Scout Players',
    hook: 'Compare any two players head-to-head on a radar chart',
    href: '/players',
  },
  {
    icon: '📈',
    name: 'Glory Index',
    hook: 'Live power ranking — who\'s the real favourite?',
    href: '/rankings',
  },
];
